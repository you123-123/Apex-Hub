...
function A.WS.RegionSnapshot(center, radius)
    ...
    for _, desc in ipairs(A.Workspace:GetDescendants()) do
...
function A.RS.Init()
    ...
    if A.Remotes then
        A.CommFRemote = A.Remotes:FindFirstChild("CommF") or A.SafeWait(A.Remotes, "CommF_") or A.SafeWait(A.Remotes, "CommF", 5)
        A.CommERemote = A.Remotes:FindFirstChild("CommE") or A.SafeWait(A.Remotes, "CommE_") or A.SafeWait(A.Remotes, "CommE", 5)
    end
