...
-- تعارض الدوال القديمة: A.IsMoving/A.GetSpeed حاكمهما نسخة core/character.lua.
-- نسخة الـ velocity الأدق تُحتفظ هنا باسم بديل لتجنب الكتابة فوق الحاكم.
function A.IsCharacterMoving()
    local hrp = GetHumanoidRootPart()
    if not hrp then
        return false
    end
