...
local function getRemote(name)
    return RS:FindFirstChild("Remotes"):FindFirstChild(name) or RS:FindFirstChild(name)
end
...
local function killMob(mobName, maxWait)
    ...
    while running and (tick() - startTime) < maxWait do
        if not A.Alive() then
            ...
            local mob = workspace:FindFirstChild("Enemies"):FindFirstChild(mobName)
                or workspace:FindFirstChild("NPCs"):FindFirstChild(mobName)
...
local function npcClick(npcName, distance)
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild(npcName)
    if not npc then
...
function module.FarmRedFlower()
    ...
    for _, pos in pairs(FLOWER_POSITIONS.Red) do
        ...
        task.wait(1)
        local flower = workspace:FindFirstChild("Flowers"):FindFirstChild("RedFlower")
            or workspace:FindFirstChild("Flowers"):FindFirstChild("Red Flower")
        if flower then
    ...
    if not collected then
        for _, v in pairs(workspace:GetDescendants()) do
            ...
            if (v.Name == "RedFlower" or v.Name == "Red Flower") and v:IsA("BasePart") then
                ...
                task.wait(0.5)
                firetouchinterest(A.HRP(), v, 0)
                task.wait(0.3)
                firetouchinterest(A.HRP(), v, 1)
                collected = true
                break
            end
        end
...
function module.FarmBlueFlower()
    ...
    for _, pos in pairs(FLOWER_POSITIONS.Blue) do
        ...
        tweenOrTeleport(pos, 250)
        task.wait(1)
        local flower = workspace:FindFirstChild("Flowers"):FindFirstChild("BlueFlower")
            or workspace:FindFirstChild("Flowers"):FindFirstChild("Blue Flower")
        if flower then
            safeTeleport(flower.Position, 3)
            task.wait(0.5)
...
function module.FarmYellowFlower()
    ...
    for _, pos in pairs(FLOWER_POSITIONS.Yellow) do
        ...
        tweenOrTeleport(pos, 250)
        task.wait(1)
        local flower = workspace:FindFirstChild("Flowers"):FindFirstChild("YellowFlower")
            or workspace:FindFirstChild("Flowers"):FindFirstChild("Yellow Flower")
        if flower then
            safeTeleport(flower.Position, 3)
            task.wait(0.5)
...
function module.AcceptV2Quest()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Alchemist")
    if npc and npc:FindFirstChild("HumanoidRootPart") then
...
function module.FarmV3Materials(race)
    ...
    while running and attempts < 200 do
        ...
        local mob = workspace:FindFirstChild("Enemies"):FindFirstChild(req.Boss)
        if mob and mob:FindFirstChild("HumanoidRootPart") and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 then
            safeTeleport(mob.HumanoidRootPart.Position, 5)
            A.Attack(mob, {"Combat"}, 0.1)
            task.wait(0.2)
...
function module.DetectFullMoon()
    ...
    localClock = lighting:FindFirstChild("ClockTime")
...
function module.PullTempleLever()
    ...
    task.wait(1)
    local lever = workspace:FindFirstChild("Temple"):FindFirstChild("Lever")
        or workspace:FindFirstChild("TempleOfTime"):FindFirstChild("Lever")
    if not lever then
        for _, v in pairs(workspace:GetDescendants()) do
...
function module.EnterTempleOfTime()
    ...
    if module.DetectFullMoon() then
        ...
        task.wait(3)
        local door = workspace:FindFirstChild("Temple"):FindFirstChild("Door")
            or workspace:FindFirstChild("TempleOfTime"):FindFirstChild("Gate")
        if not door then
            for _, v in pairs(workspace:GetDescendants()) do
...
function module.TrialHuman()
    ...
    for _, bossName in pairs(bossNames) do
        if not running then break end
        local mob = workspace:FindFirstChild("Enemies"):FindFirstChild(bossName)
        if mob and mob:FindFirstChild("HumanoidRootPart") and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 then
        ...
        if not A.Alive() then
            ...
            for _, player in pairs(Players:GetPlayers()) do
                if player ~= LP and player.Character and player.Character:FindFirstChild("HumanoidRootPart") and player.Character:FindFirstChild("Humanoid") and player.Character.Humanoid.Health > 0 then
                    local dist = (player.Character.HumanoidRootPart.Position - A.HRP().Position).Magnitude
            ...
            if nearestEnemy and nearestEnemy:FindFirstChild("HumanoidRootPart") then
                ...
                local randomPos = A.HRP().Position + Vector3.new(math.random(-50, 50), 0, math.random(-50, 50))
...
function module.TalkToAncientOne()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Ancient One")
    if not npc then
        for _, v in pairs(workspace:GetDescendants()) do
...
function module.TrainV4Gear()
    ...
    while running and (tick() - startTime) < trainDuration do
        if not A.Alive() then
            ...
            hrp = A.HRP()
            if not hrp then break end
            local mob = workspace:FindFirstChild("Enemies"):FindFirstChild("Training Dummy")
            if not mob then
...
function module.AutoDeathStep()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Death Step Teacher")
    if npc and npc:FindFirstChild("HumanoidRootPart") then
        safeTeleport(npc.HumanoidRootPart.Position, 10)
        task.wait(0.5)
        commF("DeathStep", "2")
...
function module.AutoSharkmanKarate()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Sharkman Karate")
    if npc and npc:FindFirstChild("HumanoidRootPart") then
        safeTeleport(npc.HumanoidRootPart.Position, 10)
        task.wait(0.5)
        commF("BuySharkman", "2")
...
function module.AutoElectricClaw()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Electricity Expert")
    if npc and npc:FindFirstChild("HumanoidRootPart") then
        safeTeleport(npc.HumanoidRootPart.Position, 10)
        task.wait(0.5)
    end
...
function module.AutoDragonTalon()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Dragon Talon Sage")
    if not npc then
        for _, v in pairs(workspace:GetDescendants()) do
...
function module.AutoSanguineArt()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Sanguine Art Master")
    if npc and npc:FindFirstChild("HumanoidRootPart") then
        safeTeleport(npc.HumanoidRootPart.Position, 10)
        task.wait(0.5)
        commF("SanguineArt", "1")
...
function module.AutoSaberQuest()
    ...
    task.wait(1)
    local boss = workspace:FindFirstChild("Enemies"):FindFirstChild("Saber Expert")
...
function module.AutoTushitaQuest()
    ...
    local boss = workspace:FindFirstChild("Enemies"):FindFirstChild("Longma")
    if boss and boss:FindFirstChild("HumanoidRootPart") and boss:FindFirstChild("Humanoid") and boss.Humanoid.Health > 0 then
        killMob("Longma", 180)
    end
...
function module.AutoSoulGuitar()
    ...
    for _, part in pairs(gunParts) do
        ...
        if not has or count < part.Count then
            ...
            for i = 1, 50 do
                if not running then break end
                local mob = workspace.Enemies:FindFirstChild("Cursed Captain")
                    or workspace.Enemies:FindFirstChild("Ship Engineer")
                if mob and mob:FindFirstChild("HumanoidRootPart") and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 then
                    killMob(mob.Name, 30)
                    task.wait(0.3)
                else
...
function module.AutoObservationV2()
    ...
    local npc = workspace:FindFirstChild("NPCs"):FindFirstChild("Hungry Man")
    if not npc then
        for _, v in pairs(workspace:GetDescendants()) do
    ...
    for _, food in pairs(foods) do
        ...
        if not has then
            local mob = workspace.Enemies:FindFirstChild(food)
            if mob and mob:FindFirstChild("HumanoidRootPart") and mob:FindFirstChild("Humanoid") and mob.Humanoid.Health > 0 then
                killMob(food, 60)
            else
                for _, v in pairs(workspace.Enemies:GetChildren()) do
