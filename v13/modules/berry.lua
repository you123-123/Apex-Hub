...
function Berry.CollectBerry(berry)
    ...
    local ok = SafeCall(function()
        ...
        if firetouchinterest then
            ((function() local _h=A.HRP(); if _h then firetouchinterest(_h, berry.Obj, 0) end end)())
            task.wait(0.2)
            ((function() local _h=A.HRP(); if _h then firetouchinterest(_h, berry.Obj, 1) end end)())
            task.wait(0.1)
            Berry.BerryCount = Berry.BerryCount + 1
            Berry.TotalCollected = Berry.TotalCollected + 1
            return true
